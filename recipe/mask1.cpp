////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: dom. nov. 24 22:34:55 2024
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQDraw(p,svgbkg,0);
  pvSetGeometry(p,svgbkg,2,2,99,30);
  pvSetFont(p,svgbkg,"Ubuntu",11,0,0,0,0);

  pvQComboBox(p,RECIPES,0,0,AtBottom);
  pvSetGeometry(p,RECIPES,2,2,99,30);
  pvSetFont(p,RECIPES,"Ubuntu",11,0,0,0,0);

  pvQLabel(p,RECIPE,0);
  pvSetGeometry(p,RECIPE,102,2,399,90);
  pvSetFont(p,RECIPE,"Ubuntu",11,0,0,0,0);
  pvSetStyle(p,RECIPE,Box,-1,-1,-1);

  pvQLabel(p,VALUES,0);
  pvSetGeometry(p,VALUES,102,112,399,90);
  pvSetFont(p,VALUES,"Ubuntu",11,0,0,0,0);
  pvSetStyle(p,VALUES,Box,-1,-1,-1);

  pvQPushButton(p,SET,0);
  pvSetGeometry(p,SET,2,112,99,30);
  pvSetText(p,SET,pvtr("SET RECIPE"));
  pvSetFont(p,SET,"Ubuntu",11,0,0,0,0);

  pvQSlider(p,TEMP,0,0,100,1,0,Horizontal);
  pvSetGeometry(p,TEMP,102,219,399,30);
  pvSetFont(p,TEMP,"Ubuntu",11,0,0,0,0);

  pvQSlider(p,PRESS,0,0,100,1,0,Horizontal);
  pvSetGeometry(p,PRESS,102,259,399,30);
  pvSetFont(p,PRESS,"Ubuntu",11,0,0,0,0);

  pvQLabel(p,obj1,0);
  pvSetGeometry(p,obj1,1,213,99,30);
  pvSetText(p,obj1,pvtr("Temperature"));
  pvSetFont(p,obj1,"Ubuntu",11,0,0,0,0);

  pvQLabel(p,obj2,0);
  pvSetGeometry(p,obj2,1,252,99,30);
  pvSetText(p,obj2,pvtr("        Pressure"));
