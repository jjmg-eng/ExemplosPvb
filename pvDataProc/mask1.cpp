////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: dom. abr. 13 11:06:51 2025
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLabel(p,obj1,0);
  pvSetGeometry(p,obj1,6,12,99,60);
  pvSetText(p,obj1,pvtr("Label"));
  pvSetFont(p,obj1,"Ubuntu",11,0,0,0,0);
  pvSetStyle(p,obj1,Box,-1,-1,-1);

  pvQLabel(p,obj2,0);
  pvSetGeometry(p,obj2,6,75,300,200);
  pvSetText(p,obj2,pvtr("Database"));
  pvSetFont(p,obj2,"Ubuntu",11,0,0,0,0);
  pvSetStyle(p,obj2,Box,-1,-1,-1);

  pvQPushButton(p,obj3,0);
  pvSetGeometry(p,obj3,156,27,99,30);
  pvSetText(p,obj3,pvtr("Read DB"));
