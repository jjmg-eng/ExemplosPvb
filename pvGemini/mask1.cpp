////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: sáb. jun. 7 10:22:47 2025
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLineEdit(p,_PROMPT_,0);
  pvSetGeometry(p,_PROMPT_,15,12,1336,30);
  pvSetFont(p,_PROMPT_,"Ubuntu",11,0,0,0,0);

  pvQTextBrowser(p,_RESPOSTA_,0);
  pvSetGeometry(p,_RESPOSTA_,15,54,1336,560);
  pvSetFont(p,_RESPOSTA_,"Ubuntu",11,0,0,0,0);
