////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: ter nov 18 09:19:17 2014
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQPushButton(p,UP,0);
  pvSetGeometry(p,UP,10,10,100,30);
  pvSetText(p,UP,pvtr("UP"));
  pvSetFont(p,UP,"Droid Sans",10,0,0,0,0);

  pvQPushButton(p,DOWN,0);
  pvSetGeometry(p,DOWN,120,10,100,30);
  pvSetText(p,DOWN,pvtr("DOWN"));
  pvSetFont(p,DOWN,"Droid Sans",10,0,0,0,0);

  pvQPushButton(p,STOP,0);
  pvSetGeometry(p,STOP,65,50,100,30);
  pvSetText(p,STOP,pvtr("STOP"));
  pvSetFont(p,STOP,"Droid Sans",10,0,0,0,0);

  pvQLabel(p,DISPLAY,0);
  pvSetGeometry(p,DISPLAY,65,95,100,30);
  pvSetText(p,DISPLAY,pvtr("Label"));
  pvSetFont(p,DISPLAY,"Droid Sans",10,0,0,0,0);
  pvSetStyle(p,DISPLAY,Box,-1,-1,-1);

  pvQLabel(p,UP_led,0);
  pvSetGeometry(p,UP_led,10,135,100,30);
  pvSetText(p,UP_led,pvtr("UP"));
  pvSetFont(p,UP_led,"Droid Sans",10,0,0,0,0);
  pvSetStyle(p,UP_led,Box,-1,-1,-1);

  pvQLabel(p,DOWN_led,0);
  pvSetGeometry(p,DOWN_led,120,135,100,30);
  pvSetText(p,DOWN_led,pvtr("Down"));
  pvSetFont(p,DOWN_led,"Droid Sans",10,0,0,0,0);
  pvSetStyle(p,DOWN_led,Box,-1,-1,-1);

  pvQwtDial(p,GAUGE,0);
  pvSetGeometry(p,GAUGE,12,180,210,156);
  pvSetFont(p,GAUGE,"Ubuntu",11,0,0,0,0);
