////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: qui. abr. 23 12:43:16 2026
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQPushButton(p,AUM,0);
  pvSetGeometry(p,AUM,12,285,99,30);
  pvSetText(p,AUM,pvtr("Aumenta"));
  pvSetFont(p,AUM,"Ubuntu",11,0,0,0,0);

  pvQPushButton(p,DIM,0);
  pvSetGeometry(p,DIM,165,285,99,30);
  pvSetText(p,DIM,pvtr("Diminui"));
  pvSetFont(p,DIM,"Ubuntu",11,0,0,0,0);

  pvQwtDial(p,GAUGE,0);
  pvSetGeometry(p,GAUGE,12,0,250,250);
  pvSetFont(p,GAUGE,"Ubuntu",11,0,0,0,0);

  pvQLabel(p,CONT,0);
  pvSetGeometry(p,CONT,90,252,99,30);
  pvSetText(p,CONT,pvtr("Label"));
  pvSetFont(p,CONT,"Ubuntu",11,0,0,0,0);
  pvSetStyle(p,CONT,StyledPanel,-1,-1,-1);
  pvSetStyle(p,CONT,-1,Raised,-1,-1);
  pvSetStyle(p,CONT,-1,-1,3,-1);
