////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: ter. out. 22 20:41:38 2024
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvSetGeometry(p,obj1,24,27,99,30);
  pvSetText(p,obj1,pvtr("ALARME 1"));
  pvSetFont(p,obj1,"Ubuntu",11,0,0,0,0);

  pvQPushButton(p,obj2,0);
  pvSetGeometry(p,obj2,129,27,99,30);
  pvSetText(p,obj2,pvtr("ALARME 2"));
  pvSetFont(p,obj2,"Ubuntu",11,0,0,0,0);

  pvQPushButton(p,obj3,0);
  pvSetGeometry(p,obj3,234,27,99,30);
  pvSetText(p,obj3,pvtr("ALARME 3"));
  pvSetFont(p,obj3,"Ubuntu",11,0,0,0,0);

  pvQPushButton(p,obj4,0);
  pvSetGeometry(p,obj4,339,27,99,30);
  pvSetText(p,obj4,pvtr("ALARME 4"));
  pvSetFont(p,obj4,"Ubuntu",11,0,0,0,0);

  pvQPushButton(p,obj5,0);
  pvSetGeometry(p,obj5,24,66,99,30);
  pvSetText(p,obj5,pvtr("ALARME 5"));
  pvSetFont(p,obj5,"Ubuntu",11,0,0,0,0);

  pvQPushButton(p,obj6,0);
  pvSetGeometry(p,obj6,129,66,99,30);
  pvSetText(p,obj6,pvtr("ALARME 6"));
  pvSetFont(p,obj6,"Ubuntu",11,0,0,0,0);

  pvQPushButton(p,obj7,0);
  pvSetGeometry(p,obj7,234,66,99,30);
  pvSetText(p,obj7,pvtr("ALARME 7"));
  pvSetFont(p,obj7,"Ubuntu",11,0,0,0,0);

  pvQPushButton(p,obj8,0);
  pvSetGeometry(p,obj8,339,66,99,30);
  pvSetText(p,obj8,pvtr("ALARME 8"));
